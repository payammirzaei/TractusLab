...
export function DataJourney() {
  ...
  const sceneProps = { chapter: state.chapter, progress, fault: state.fault, paused: paused || state.complete, reduced: motionReduced, depth, selected, onSelect: (id: NodeId) => setSelected(current => current === id ? null : id) };
