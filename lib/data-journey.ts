...
export const chapters: Chapter[] = [
  ...
  { id: "publish", label: "Publish", title: "Make it findable. Keep it local.", verb: "Discover the offer", signal: "METADATA ONLY", focus: "catalog", duration: 10,
    story: "Company A configures an offer with a description and terms in its own connector. That makes it discoverable through the catalogue. The green data core stays local.",
  ...
  { id: "discover", label: "Discover", title: "A question travels. An offer returns.", verb: "Explore the trust check", signal: "CATALOGUE REQUEST / RESPONSE", focus: "catalog", duration: 13,
    story: "First, Company B asks for Company A’s catalogue. Company A checks the requester and selects visible offers. Only then does it send a reply with metadata and terms. The record stays at its source.",
  ...
  { id: "identity", label: "Trust", title: "Trust is proven, not assumed.", verb: "Check the terms", signal: "CREDENTIAL VERIFICATION", focus: "identity", duration: 12,
    story: "Let’s look inside a protected interaction. Company B presents identity evidence; Company A verifies it. Only after a successful check do the rings align. These checks already occur during catalogue access.",
  ...
  { id: "agreement", label: "Agree", title: "Two decisions. One agreement.", verb: "Initiate the transfer", signal: "CONTRACT NEGOTIATION", focus: "agreement", duration: 19,
    story: "Company B requests the offered contract. Company A checks it and sends an agreement. Company B verifies; Company A finalizes. Only then does the golden seal form. No record has moved yet.",
  ...
  { id: "transfer", label: "Transfer", title: "Now the data can travel.", verb: "See the result", signal: "ACCESS SETUP → DATA DELIVERY", focus: "consumer", duration: 21,
    story: "First, Company B requests access under the agreement. Company A authorizes it and returns access information. Company B then asks for the record. The data plane reads the source and delivers a copy; the original stays with Company A.",
    architect: "This simplified HTTP pull example separates control-plane access setup from data-plane retrieval and payload delivery. Receiving a record does not imply that an HTTP pull transfer process has entered the COMPLETED state.",
